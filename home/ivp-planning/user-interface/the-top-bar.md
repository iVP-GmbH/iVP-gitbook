...
|                                                                                                                 |                                                                          |
| --------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| ![Layout Presets](../../../.gitbook/assets/planning_top_bar_layout_presets.png){width=100}                      | Opens a small submenu that lets you choose a [window layout](layouts.md) |
| ![Layers](../../../.gitbook/assets/planning_top_bar_layers.png){width=100}                                      | Opens a submenu where you can show or hide layers.                       |
| ![Report an Error](../../../.gitbook/assets/planning_top_bar_report_an_error.png){width=100}                    | Opens the [bug report panel](../bug-reporting.md)                        |
| ![Help, FAQ and Documentation](../../../.gitbook/assets/planning_top_bar_help_faq_documentation.png){width=100} | Opens the [main page](../../) of this documentation                      |
| ![About iVP](../../../.gitbook/assets/planning_top_bar_about_ivp.png){widht=100}                                | Opens the about dialog, containing the [changelog](/changelog-panel.md) and the [3rd Party Licenses](../open-source-licensing.md)                        |
| ![User Account](../../../.gitbook/assets/planning_top_bar_user_account.png){width=100}                          | Opens a small submenu where you can log out and see your user profile.|