...
<img src="../../../.gitbook/assets/hierarchy_lock.png" alt="" data-size="line">

## Lock/Unlock objects

To prevent objects from being [selected and moved](../machines/selecting-and-moving-objects.md#selecting-objects-in-the-2d--and-3d-panel) in the [2D](the-2d-panel.md) and [3D view](the-3d-panel.md) and  press the  **Lock/Unlock Machine** button.
